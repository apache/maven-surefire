...
public class SimpleReportEntry implements TestSetReportEntry {
    ...
    public SimpleReportEntry(
            @Nonnull RunMode runMode, Long testRunId, String source, String sourceText, String name, String nameText) {
    ...
    public SimpleReportEntry(
        ...
        this(
                ...
                stackTraceWriter,
                elapsed,
                safeGetMessage(stackTraceWriter),
                systemProperties);
    }

    public static SimpleReportEntry assumption(
            RunMode runMode,
            Long testRunId,
            String source,
            String sourceText,
    ...
    public static SimpleReportEntry ignored(
            RunMode runMode,
            Long testRunId,
            String source,
            String sourceText,
    ...
    public static SimpleReportEntry withException(
            RunMode runMode,
            Long testRunId,
            String source,
            String sourceText,
    ...
    public boolean equals(Object o) {
        ...
        return isRunModeEqual(that)
                && isTestRunIdEqual(that)
                && isSourceEqual(that)
                && isSourceTextEqual(that)
                && isNameEqual(that)
                && isNameTextEqual(that)
                && isStackEqual(that)
