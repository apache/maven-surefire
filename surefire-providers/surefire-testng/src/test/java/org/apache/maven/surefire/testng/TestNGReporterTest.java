...
public class TestNGReporterTest extends TestCase {
    public void testParameterizedTestName() throws Exception {
        ...
        assertThat(testName).isEqualTo("myTest[val1, val2](3)");
    }
    ...
    public void testOnTestStart() {
        ...
        assertThat(reportEntry.getValue().getTestRunId()).isEqualTo(0x0000000100000001L);

        assertThat(reportEntry.getValue().getSourceName()).isEqualTo("pkg.MyClass");

        assertThat(reportEntry.getValue().getName()).isEqualTo("myTest[val1, val2](3)");
    }
    ...
    public void testOnTestFailure() {
        ...
        assertThat(reportEntry.getValue().getSourceName()).isEqualTo(getClass().getName());

        assertThat(reportEntry.getValue().getName()).isEqualTo("myTest[val1, val2](1)");

        assertThat(reportEntry.getValue().getStackTraceWriter()).isNotNull();
    ...
    public void testOnSkippedTest() {
        ...
        assertThat(reportEntry.getValue().getMessage()).isEqualTo(stackTrace.getMessage());
    }
