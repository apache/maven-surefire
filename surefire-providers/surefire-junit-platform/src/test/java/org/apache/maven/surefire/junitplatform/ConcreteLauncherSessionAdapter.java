...
class ConcreteLauncherSessionAdapter implements LauncherSessionAdapter {
    ...
    public static LauncherSessionFactory createLauncherSessionWithListeners(TestExecutionListener... listeners) {
        LauncherConfig launcherConfig =
                LauncherConfig.builder().addTestExecutionListeners(listeners).build();
        return () -> new ConcreteLauncherSessionAdapter(LauncherFactory.openSession(launcherConfig));
    }
