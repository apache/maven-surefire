 ...
 * @version $Revision: $
 */
public class MavenSurefireJUnit48RunnerTest extends TestCase {
    ...
    public void testSurefireShouldBeAbleToReportRunStatusEvenWithFailingTests() throws Exception {
