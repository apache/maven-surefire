...
public final class JUnitCoreParameters {
    ...
    public static final String ENABLE_OUTPUT_ELEMENTS_KEY = ProviderParameterNames.ENABLE_OUTPUT_ELEMENTS_PROP;
    ...
    public JUnitCoreParameters(Map<String, String> properties) {
        ...
        enableOutputElements = property(properties, ENABLE_OUTPUT_ELEMENTS_KEY, true);
    }
    ...
    public String toString() {
        return "parallel='" + parallel + '\'' + ", perCoreThreadCount=" + perCoreThreadCount + ", threadCount="
                ...
                + ", enableOutputElements=" + enableOutputElements;
    }
