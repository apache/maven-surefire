...
public class EventChannelEncoderTest {
    ...
    public void reportEntry() throws IOException {
        ...
        expectedFrame.write(':');
        expectedFrame.write(
                reportEntry.getStackTraceWriter().smartTrimmedStackTrace().getBytes(UTF_8));
        expectedFrame.write(':');
        ...
        assertThat(toArray(encoded)).isEqualTo(expectedFrame.toByteArray());
        ...
        expectedFrame.write(trimmedStackTrace.getBytes(UTF_8));
        expectedFrame.write(':');
        assertThat(out.toByteArray()).isEqualTo(expectedFrame.toByteArray());
    ...
    public void testBye() {
        ...
        assertThat(encoded).isEqualTo(":maven-surefire-event:\u0003:bye:");
    }
    ...
    public void testStopOnNextTest() {
        ...
        String encoded = new String(out.toByteArray(), UTF_8);
        assertThat(encoded).isEqualTo(":maven-surefire-event:\u0011:stop-on-next-test:");
    }
    ...
    public void testAcquireNextTest() {
        ...
        String encoded = new String(out.toByteArray(), UTF_8);
        assertThat(encoded).isEqualTo(":maven-surefire-event:\u0009:next-test:");
    }
    ...
    public void shouldCountSameNumberOfSystemProperties() throws IOException {
        ...
        for (Entry<String, String> entry : sysProps.entrySet()) {
            ...
            expectedFrame.write((entry.getValue() == null ? "\u0000" : entry.getValue()).getBytes(UTF_8));
            expectedFrame.write(':');
            assertThat(stream.toByteArray()).contains(expectedFrame.toByteArray());
        }
    }
    ...
    public void shouldHandleExit() {
        ...
        assertThat(new String(out.toByteArray(), UTF_8))
                .startsWith(
                        ":maven-surefire-event:\u000e:jvm-exit-error:\u0005:UTF-8:\u0000\u0000\u0000\u0001:1:\u0000\u0000\u0000\u0001:2:\u0000\u0000\u0000\u0001:3:");
    }
    ...
    public void shouldHandleExitWithTrimmedTrace() {
        ...
        assertThat(new String(out.toByteArray(), UTF_8))
                .startsWith(
                        ":maven-surefire-event:\u000e:jvm-exit-error:\u0005:UTF-8:\u0000\u0000\u0000\u0001:1:\u0000\u0000\u0000\u0001:2:\u0000\u0000\u0000\u0001:4:");
    }
