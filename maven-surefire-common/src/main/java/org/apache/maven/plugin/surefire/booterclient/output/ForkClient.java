...
public final class ForkClient implements EventHandler<Event> {
    ...
    private final class ConsoleListener implements ForkedProcessStringEventListener {
        ...
        public void handle(String msg) {
            getOrCreateConsoleLogger().info(msg);
        }
    }
    ...
    private class ErrorListener implements ForkedProcessStackTraceEventListener {
        ...
        public void handle(@Nonnull StackTraceWriter stackTrace) {
            ...
            if (errorInFork == null) {
                ...
                if (msg != null) {
                    getOrCreateConsoleLogger().error(msg);
                }
            }
            dumpToLoFile(msg);
        }
    ...
    private final class DebugListener implements ForkedProcessStringEventListener {
        @Override
        public void handle(String msg) {
            getOrCreateConsoleLogger().debug(msg);
        }
    }
    ...
    private final class WarningListener implements ForkedProcessStringEventListener {
        @Override
        public void handle(String msg) {
            getOrCreateConsoleLogger().warning(msg);
        }
    }
    ...
    private final class ExitErrorEventListener implements ForkedProcessExitErrorListener {
        ...
        public void handle(StackTraceWriter stackTrace) {
            getOrCreateConsoleLogger().error("The surefire booter JVM" + forkNumber + " was interrupted and exits.");
        }
    }
    ...
    private void writeTestOutput(
            String output, boolean isStdout, boolean newLine, RunMode runMode, Long testRunId, String stack) {
        getConsoleOutputReceiver()
                .writeTestOutput(new TestOutputReportEntry(output, isStdout, newLine, runMode, testRunId, stack));
    }
