...
public class EventDecoderTest {
    ...
    public void shouldMapEventTypes() throws Exception {
        ...
        assertThat(eventTypes).hasSize(ForkedProcessEventType.values().length);
    }
    ...
    public void shouldMapRunModes() throws Exception {
        ...
        assertThat(map.get(segment)).isEqualTo(NORMAL_RUN);

        stream = "rerun-test-after-failure".getBytes(US_ASCII);
        segment = new Segment(stream, 0, stream.length);
        assertThat(map.get(segment)).isEqualTo(RERUN_TEST_AFTER_FAILURE);
    }
    ...
    public void shouldMapEventTypeToSegmentType() {
        ...
        assertThat(segmentTypes).hasSize(1).containsOnly(END_OF_FRAME);
    ...
    public void shouldCreateEvent() throws Exception {
        ...
        assertThat(event).isInstanceOf(ControlByeEvent.class);

        event = decoder.toMessage(BOOTERCODE_STOP_ON_NEXT_TEST, decoder.new Memento());
        assertThat(event).isInstanceOf(ControlStopOnNextTestEvent.class);

        event = decoder.toMessage(BOOTERCODE_NEXT_TEST, decoder.new Memento());
        assertThat(event).isInstanceOf(ControlNextTestEvent.class);
        ...
        assertThat(event).isInstanceOf(ConsoleErrorEvent.class);
        ...
        assertThat(consoleErrorEvent.getStackTraceWriter().smartTrimmedStackTrace())
                .isEqualTo("2");
        assertThat(consoleErrorEvent.getStackTraceWriter().writeTraceToString()).isEqualTo("3");
        ...
        assertThat(consoleErrorEvent.getStackTraceWriter()).isNull();

        memento = decoder.new Memento();
        memento.getData().addAll(asList("1", "2", "3"));
        event = decoder.toMessage(BOOTERCODE_JVM_EXIT_ERROR, memento);
        assertThat(event).isInstanceOf(JvmExitErrorEvent.class);
        ...
        assertThat(jvmExitErrorEvent.getStackTraceWriter().smartTrimmedStackTrace())
                .isEqualTo("2");
        assertThat(jvmExitErrorEvent.getStackTraceWriter().writeTraceToString()).isEqualTo("3");
        ...
        assertThat(jvmExitErrorEvent.getStackTraceWriter()).isNull();
        ...
        assertThat(((TestsetStartingEvent) event).getReportEntry().getTestRunId())
                .isEqualTo(1L);
        assertThat(((TestsetStartingEvent) event).getReportEntry().getSourceName())
                .isEqualTo("source");
        ...
        assertThat(((TestsetCompletedEvent) event).getReportEntry().getRunMode())
                .isEqualTo(NORMAL_RUN);
        assertThat(((TestsetCompletedEvent) event).getReportEntry().getTestRunId())
                .isEqualTo(1L);
        assertThat(((TestsetCompletedEvent) event).getReportEntry().getSourceName())
                .isEqualTo("source");
        ...
        assertThat(((TestsetCompletedEvent) event).getReportEntry().getMessage())
                .isNull();
        assertThat(((TestsetCompletedEvent) event).getReportEntry().getElapsed())
                .isEqualTo(5);
        ...
        assertThat(((TestSucceededEvent) event).getReportEntry().getSourceName())
                .isEqualTo("source");
        ...
        assertThat(((TestSucceededEvent) event).getReportEntry().getStackTraceWriter())
                .isNull();

        memento = decoder.new Memento();
        memento.getData()
                .addAll(asList(
                        RERUN_TEST_AFTER_FAILURE,
                        1L,
                        "source",
                        null,
                        "name",
        ...
        assertThat(((TestAssumptionFailureEvent) event).getReportEntry().getRunMode())
                .isEqualTo(NORMAL_RUN);
        assertThat(((TestAssumptionFailureEvent) event).getReportEntry().getTestRunId())
                .isEqualTo(1L);
        ...
        assertThat(((TestAssumptionFailureEvent) event).getReportEntry().getName())
                .isEqualTo("name");
        assertThat(((TestAssumptionFailureEvent) event).getReportEntry().getNameText())
                .isNull();
        assertThat(((TestAssumptionFailureEvent) event).getReportEntry().getGroup())
                .isEqualTo("group");
        assertThat(((TestAssumptionFailureEvent) event).getReportEntry().getMessage())
                .isNull();
        assertThat(((TestAssumptionFailureEvent) event).getReportEntry().getElapsed())
                .isEqualTo(5);
    ...
    public void shouldRecognizeEmptyStream4ReportEntry() {
        ...
        assertThat(reportEntry.getStackTraceWriter().writeTrimmedTraceToString())
                .isEmpty();
    ...
    public void testCreatingReportEntry() {
        ...
        decodedReportEntry = newReportEntry(
                NORMAL_RUN,
                1L,
                reportEntry.getSourceName(),
                reportEntry.getSourceText(),
