...
public class BooterDeserializerStartupConfigurationTest extends TestCase {
    ...
    private void assertCpConfigEquals(
            ClasspathConfiguration expectedConfiguration, ClasspathConfiguration actualConfiguration) {
        assertEquals(
                expectedConfiguration.getTestClasspath().getClassPath(),
    ...
    private ProviderConfiguration getProviderConfiguration() {
        ...
        DirectoryScannerParameters directoryScannerParameters =
                new DirectoryScannerParameters(cwd, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), "hourly");
