...
public class StatelessReporterTest {
    ...
    public void shouldCloneXmlReporter() {
        ...
        assertThat(clone).isNotSameAs(extension);
        assertThat(clone).isInstanceOf(SurefireStatelessReporter.class);
        assertThat(clone.toString()).isEqualTo("SurefireStatelessReporter{version=V1, disable=true}");
        assertThat(((SurefireStatelessReporter) clone).isDisable()).isTrue();
        assertThat(((SurefireStatelessReporter) clone).getVersion()).isEqualTo("V1");
    }
    ...
    public void shouldCreateConsoleListener() {
        ...
        assertThat(extension.isDisable()).isFalse();
        extension.setDisable(true);
        assertThat(extension.isDisable()).isTrue();

        StatelessReportEventListener<WrappedReportEntry, TestSetStats> listener = extension.createListener(config);
        assertThat(listener).isInstanceOf(StatelessXmlReporter.class);
        assertThat((File) getInternalState(listener, "reportsDirectory")).isSameAs(reportsDirectory);
        assertThat((String) getInternalState(listener, "reportNameSuffix")).isSameAs(reportNameSuffix);
        assertThat((boolean) getInternalState(listener, "trimStackTrace")).isEqualTo(true);
        assertThat((Integer) getInternalState(listener, "rerunFailingTestsCount"))
                .isEqualTo(5);
        assertThat((String) getInternalState(listener, "xsdSchemaLocation")).isSameAs(schema);
        assertThat((String) getInternalState(listener, "xsdVersion")).isEqualTo("V3");
        assertThat((Map<?, ?>) getInternalState(listener, "testClassMethodRunHistoryMap"))
                .isSameAs(testClassMethodRunHistory);
        assertThat((boolean) getInternalState(listener, "phrasedFileName")).isEqualTo(false);
        assertThat((boolean) getInternalState(listener, "phrasedSuiteName")).isEqualTo(false);
        assertThat((boolean) getInternalState(listener, "phrasedClassName")).isEqualTo(false);
        assertThat((boolean) getInternalState(listener, "phrasedMethodName")).isEqualTo(false);
    }
    ...
    public void shouldCloneJUnit5XmlReporter() {
        ...
        Object clone = extension.clone(classLoader);
        assertThat(clone).isNotSameAs(extension);
        assertThat(clone).isInstanceOf(JUnit5Xml30StatelessReporter.class);
        ...
        assertThat(((JUnit5Xml30StatelessReporter) clone).isDisable()).isTrue();
        assertThat(((JUnit5Xml30StatelessReporter) clone).getVersion()).isEqualTo("V1");
    ...
    public void shouldCreateJUnit5ConsoleListener() {
        ...
        assertThat(extension.getUsePhrasedFileName()).isFalse();
        extension.setUsePhrasedFileName(true);
        assertThat(extension.getUsePhrasedFileName()).isTrue();

        assertThat(extension.getUsePhrasedTestSuiteClassName()).isFalse();
        extension.setUsePhrasedTestSuiteClassName(true);
        assertThat(extension.getUsePhrasedTestSuiteClassName()).isTrue();

        assertThat(extension.getUsePhrasedTestCaseClassName()).isFalse();
        extension.setUsePhrasedTestCaseClassName(true);
        assertThat(extension.getUsePhrasedTestSuiteClassName()).isTrue();

        assertThat(extension.getUsePhrasedTestCaseMethodName()).isFalse();
        extension.setUsePhrasedTestCaseMethodName(true);
        assertThat(extension.getUsePhrasedTestCaseMethodName()).isTrue();
        ...
        assertThat((Map<?, ?>) getInternalState(listener, "testClassMethodRunHistoryMap"))
                .isSameAs(testClassMethodRunHistory);
        assertThat((boolean) getInternalState(listener, "phrasedFileName")).isEqualTo(true);
        assertThat((boolean) getInternalState(listener, "phrasedSuiteName")).isEqualTo(true);
        assertThat((boolean) getInternalState(listener, "phrasedClassName")).isEqualTo(true);
        assertThat((boolean) getInternalState(listener, "phrasedMethodName")).isEqualTo(true);
    }
}
