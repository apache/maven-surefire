...
public class RunEntryStatisticsMapTest extends TestCase {
    ...
    public void testDeserializeClass() throws Exception {
        ...
        assertThat(runEntryStatistics).hasSize(1);
        ClassMethod cm = (ClassMethod) runEntryStatistics.keySet().iterator().next();
        assertThat(cm.getClazz()).isEqualTo("abc");
        assertThat(cm.getMethod()).isNull();
        RunEntryStatistics statistics =
                (RunEntryStatistics) runEntryStatistics.values().iterator().next();
        assertThat(statistics.getRunTime()).isEqualTo(42);
    ...
    public void testSerialize() throws Exception {
        ...
        ReportEntry reportEntry1 = new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "method1", null, 42);
        ReportEntry reportEntry2 = new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "willFail", null, 17);
        ReportEntry reportEntry3 = new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "method3", null, 100);
        ...
        ReportEntry newRunReportEntry1 = new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "method1", null, 52);
        ReportEntry newRunReportEntry2 = new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "willFail", null, 27);
        ReportEntry newRunReportEntry3 = new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "method3", null, 110);
    ...
    public void testMultiLineTestMethodName() throws IOException {
        ...
        ReportEntry reportEntry =
                new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "line1\nline2" + NL + " line3", null, 42);
    ...
    public void testCombinedMethodNames() throws IOException {
        File data = SureFireFileManager.createTempFile("surefire-unit", "test");
        RunEntryStatisticsMap reportEntries = RunEntryStatisticsMap.fromFile(data);
        reportEntries.add(reportEntries.createNextGeneration(
                new SimpleReportEntry(NORMAL_RUN, 0L, "abc", null, "line1\nline2", null, 42)));
        reportEntries.add(reportEntries.createNextGeneration(
