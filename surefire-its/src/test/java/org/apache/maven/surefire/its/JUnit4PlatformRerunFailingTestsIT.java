...
public class JUnit4PlatformRerunFailingTestsIT extends SurefireJUnit4IntegrationTestCase {
    ...
    public void testRerunFailingErrorTestsWithOneRetry() {
        ...
        outputValidator = unpack().setJUnitVersion(VERSION)
                .maven()
                .debugLogging()
                .addGoal("-Dsurefire.rerunFailingTestsCount=1")
                .addGoal("-DforkCount=2")
                .withFailure()
                .executeTest()
                .assertTestSuiteResults(5, 1, 1, 0, 0);
        verifyFailuresOneRetryAllClasses(outputValidator);
        ...
        outputValidator = unpack().setJUnitVersion(VERSION)
                ...
                .debugLogging()
                .addGoal("-Dsurefire.rerunFailingTestsCount=1")
                .addGoal("-Dparallel=methods")
                .addGoal("-DuseUnlimitedThreads=true")
                .withFailure()
                .executeTest()
                .assertTestSuiteResults(5, 1, 1, 0, 0);
        verifyFailuresOneRetryAllClasses(outputValidator);
    ...
    public void testRerunOneTestClass() {
        OutputValidator outputValidator = unpack().setJUnitVersion(VERSION)
                ...
                .debugLogging()
                .addGoal("-Dsurefire.rerunFailingTestsCount=1")
                .addGoal("-Dtest=FlakyFirstTimeTest")
                .withFailure()
                .executeTest()
    ...
    public void testRerunOneTestMethod() {
        OutputValidator outputValidator = unpack().setJUnitVersion(VERSION)
                .maven()
                .addGoal("-Dsurefire.rerunFailingTestsCount=1")
                .addGoal("-Dtest=FlakyFirstTimeTest#testFailing*")
                .withFailure()
                .debugLogging()
                .executeTest()
    ...
    public void testParameterizedTest() {
        unpack().setJUnitVersion(VERSION)
                .maven()
    ...
    private void verifyFailuresOneRetry(
            OutputValidator outputValidator, int run, int failures, int errors, int flakes) {
    ...
    private void verifyOnlyFailuresOneRetry(
            OutputValidator outputValidator, int run, int failures, int errors, int flakes) {
        outputValidator.verifyTextInLog("Failures:");
        outputValidator.verifyTextInLog("Run 1: FlakyFirstTimeTest.testFailingTestOne");
        outputValidator.verifyTextInLog("Run 2: FlakyFirstTimeTest.testFailingTestOne");
    ...
    private void verifyFailuresTwoRetry(
            OutputValidator outputValidator, int run, int failures, int errors, int flakes) {
