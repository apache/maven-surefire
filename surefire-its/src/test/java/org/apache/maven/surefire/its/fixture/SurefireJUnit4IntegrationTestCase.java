...
public abstract class SurefireJUnit4IntegrationTestCase
{
    ...
    {
        boolean isJava9CapableTest = AbstractJava9PlusIT.class.isAssignableFrom( testClass );
        boolean useIllegalJava9Access = isJDK9Plus() && !isJava9CapableTest;
        MavenLauncher mavenLauncher = new MavenLauncher( testClass, sourceName, suffix, cli, useIllegalJava9Access );
