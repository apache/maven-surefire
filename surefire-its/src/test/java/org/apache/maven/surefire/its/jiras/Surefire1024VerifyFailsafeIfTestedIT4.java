 ...
 * @since 2.19
 */
public class Surefire1024VerifyFailsafeIfTestedIT4 extends SurefireJUnit4IntegrationTestCase {

    @Test
    public void shouldScanAndRunTestsInDependencyJars() throws Exception {
        SurefireLauncher launcher = unpack("surefire-1024");
        launcher.executeVerify().verifyTextInLog("class jiras.surefire1024.A1IT#test() dependency to scan");

        launcher.getSubProjectValidator("jiras-surefire-1024-it").assertIntegrationTestSuiteResults(1, 0, 0, 0);
    }
}
