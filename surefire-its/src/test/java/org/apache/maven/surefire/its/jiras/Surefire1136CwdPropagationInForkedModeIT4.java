 ...
 * @author Norbert Wnuk
 */
public class Surefire1136CwdPropagationInForkedModeIT4 extends SurefireJUnit4IntegrationTestCase {
    @Test
    public void testTestNgAndJUnitTogether() {
        OutputValidator outputValidator =
                unpack("surefire-1136-cwd-propagation-in-forked-mode").executeTest();
