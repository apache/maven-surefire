 ...
 *
 */
public class Surefire828EmptyGroupExprIT extends SurefireJUnit4IntegrationTestCase {
    // !CategoryC
    @Test
    public void testJUnitRunEmptyGroups() {
        OutputValidator validator =
                unpackJUnit().sysProp("profile", "emptyGroups").executeTest();
    ...
    public void testJUnitRunEmptyExcludeGroups() {
        OutputValidator validator =
                unpackJUnit().sysProp("profile", "emptyExcludedGroups").executeTest();
        validator.verifyErrorFreeLog();
    ...
    public void testTestNGRunEmptyExcludeGroups() {
        OutputValidator validator =
                unpackTestNG().sysProp("profile", "emptyExcludedGroups").executeTest();
        validator.verifyErrorFreeLog();
        validator.assertTestSuiteResults(2, 0, 0, 0);
    ...
    public void testTestNGRunEmptyGroups() {
        OutputValidator validator =
                unpackTestNG().sysProp("profile", "emptyGroups").executeTest();
        validator.verifyErrorFreeLog();
