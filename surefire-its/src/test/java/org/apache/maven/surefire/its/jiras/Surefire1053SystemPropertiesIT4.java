 ...
 * @since 2.18
 */
public class Surefire1053SystemPropertiesIT4 extends SurefireJUnit4IntegrationTestCase {
    @Test
    ...
    public void checkWarningsSysPropTwice() throws Exception {
        OutputValidator validator = unpack().argLine("-DmyArg=myVal2 -Dfile.encoding=ISO-8859-1")
