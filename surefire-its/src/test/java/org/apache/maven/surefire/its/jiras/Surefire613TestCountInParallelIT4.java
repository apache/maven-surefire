...
public class Surefire613TestCountInParallelIT4 extends SurefireJUnit4IntegrationTestCase {
    @Test
    public void testParallelBuildResultCount() {
        OutputValidator validator =
                unpack("/surefire-613-testCount-in-parallel").failNever().executeTest();
