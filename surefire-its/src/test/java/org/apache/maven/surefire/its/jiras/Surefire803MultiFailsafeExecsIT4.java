 ...
 *
 */
public class Surefire803MultiFailsafeExecsIT4 extends SurefireJUnit4IntegrationTestCase {

    @Test
    public void testSecondExecutionRunsAfterFirstExecutionFails() {
        unpack("/surefire-803-multiFailsafeExec-failureInFirst")
                .maven()
                .withFailure()
                .executeVerify()
    ...
    public void testOneExecutionRunInTwoBuilds() {
        ...
        launcher.sysProp("success", "false")
                ...
                .withFailure()
                .executeVerify()
                .assertIntegrationTestSuiteResults(1, 0, 1, 0);
        launcher.reset();
