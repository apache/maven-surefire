 ...
 * @since 2.20.1
 */
public class Java9FullApiIT extends AbstractJava9PlusIT {
    @Test
    @SuppressWarnings("checkstyle:methodname")
    public void shouldLoadMultipleJavaModules_JavaHome() throws Exception {
        OutputValidator validator =
                assumeJava9().setForkJvm().debugLogging().execute("verify").verifyErrorFree(1);

        validator
                .verifyTextInLog("loaded class java.sql.SQLException")
                ...
                .assertThatLogLine(is("java.specification.version=" + (int) JAVA_VERSION), greaterThanOrEqualTo(1));
    }
