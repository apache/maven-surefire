...
public class Surefire946KillMainProcessInReusableForkIT4 extends SurefireJUnit4IntegrationTestCase {
    ...
    public static void installSelfdestructPlugin() {
        unpack(Surefire946KillMainProcessInReusableForkIT4.class, "surefire-946-self-destruct-plugin", "plugin")
                .executeInstall();
    }
