...
public class Surefire1177TestngParallelSuitesIT extends SurefireJUnitIntegrationTestCase {
    ...
    @Test
    public void twoSuitesInParallel() throws VerificationException {
        OutputValidator validator = unpack().forkNever().executeTest().verifyErrorFree(2);
    ...
    @Test
    public void twoSuitesInParallelForked() throws VerificationException {
        OutputValidator validator = unpack().forkOnce().executeTest().verifyErrorFree(2);
