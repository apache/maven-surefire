 ...
 */
public class JUnit448TestCategoriesIT extends SurefireJUnit4IntegrationTestCase {
    @Test
    ...
    private static void runBadCategory(SurefireLauncher unpacked) {
        unpacked.failIfNoTests(false).groups("BadCategory").executeTest().verifyErrorFreeLog();
    }
