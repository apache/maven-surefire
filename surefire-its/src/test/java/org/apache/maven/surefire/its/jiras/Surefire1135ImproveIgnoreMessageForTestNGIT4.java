 ...
 */
public class Surefire1135ImproveIgnoreMessageForTestNGIT4 extends SurefireJUnit4IntegrationTestCase {
    ...
    private void testNgReport(
        ...
        assertThat("Not expected classname", test.getAttribute("classname"), is("testng.SkipExceptionReportTest"));
