 ...
 * @since 2.20.1
 */
public class Surefire1367AssumptionLogsIT4 extends SurefireJUnit4IntegrationTestCase {
    ...
    public void shouldSeeLogsForked() {
        OutputValidator outputValidator =
                unpack().setForkJvm().forkOnce().executeTest().assertTestSuiteResults(2, 0, 0, 2);
    ...
    private void verifyReportA(OutputValidator outputValidator) {
        String xmlReport =
                outputValidator.getSurefireReportsXmlFile("TEST-ATest.xml").readFileToString();
        ...
        String output =
                outputValidator.getSurefireReportsFile("ATest-output.txt").readFileToString();
    ...
    private void verifyReportB(OutputValidator outputValidator) {
        String xmlReport =
                outputValidator.getSurefireReportsXmlFile("TEST-BTest.xml").readFileToString();
        ...
        String output =
                outputValidator.getSurefireReportsFile("BTest-output.txt").readFileToString();
