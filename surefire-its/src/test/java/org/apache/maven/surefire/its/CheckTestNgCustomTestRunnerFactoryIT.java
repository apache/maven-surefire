 ...
 */
public class CheckTestNgCustomTestRunnerFactoryIT extends SurefireJUnit4IntegrationTestCase {
    @Test
    public void testTestNgListenerReporter() throws IOException {
        File baseDir = unpack().executeTest()
                .verifyErrorFreeLog()
