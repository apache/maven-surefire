        ...
        extends SurefireJUnit4IntegrationTestCase
{
    ...
    public void test() throws VerificationException
    {
        ...
        SurefireLauncher relauncher = unpack( "surefire-1383-working-copy-modifications" );
        relauncher.executeTest();
        relauncher.getSubProjectValidator( "sut" ).assertTestSuiteResults( 2, 0, 0, 0 );
    }
}
