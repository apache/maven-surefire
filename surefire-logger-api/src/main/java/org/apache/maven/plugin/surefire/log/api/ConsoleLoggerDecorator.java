...
public final class ConsoleLoggerDecorator implements ConsoleLogger {
    ...
    public void error(String message, Throwable t) {
        try {
            logger.getClass().getMethod("error", String.class, Throwable.class).invoke(logger, message, t);
        } catch (Exception e) {
    ...
    public void error(Throwable t) {
        try {
            logger.getClass().getMethod("error", Throwable.class).invoke(logger, t);
        } catch (Exception e) {
            throw new IllegalStateException(e.getLocalizedMessage(), e);
        }
    }
    ...
    private boolean invokeReturnedBoolean(String isErrorEnabled) {
        try {
            return (Boolean) logger.getClass().getMethod(isErrorEnabled).invoke(logger);
        } catch (Exception e) {
            throw new IllegalStateException(e.getLocalizedMessage(), e);
        }
    }
